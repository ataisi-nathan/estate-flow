...
export default {
  displayName: 'types', // IMPORTANT: Change to 'auth' for auth, 'types' for types
  ...
  coverageDirectory: '../../coverage/libs/types', // IMPORTANT: Change to 'libs/auth' for auth, 'libs/types' for types
